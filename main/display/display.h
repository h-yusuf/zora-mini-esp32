...
public:
    ...
    // Show a standalone line of text for a while (used by the info ticker on
    // displays whose normal UI has no text area). No-op by default.
    virtual void ShowInfoText(const char* text, int duration_ms) {}
